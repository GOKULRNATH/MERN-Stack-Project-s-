...
const editFoodById=(req,res)=>{
  ...
  food.findByIdAndUpdate({_id:req.body.id},{
    foodname:req.body.foodname,
        vegornon:req.body.vegornon,
        price:req.body.price,
        type:req.body.type,
...
const deleteFoodById=(req,res)=>{
  ...
  food.findByIdAndDelete({_id:req.body.id})
.exec().then(data=>{
  res.json({
      status:200,
...
module.exports={addFood,upload,viewAllFoodItemss,editFoodById,viewFoodById,viewFoodByRest,
  deleteFoodById}